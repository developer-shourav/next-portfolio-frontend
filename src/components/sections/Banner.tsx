...
const Banner = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-indigo-900/20">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-indigo-500/10 rounded-full filter blur-3xl animate-pulse-slow" />
      <div className="absolute bottom-20 right-10 w-64 h-64 bg-purple-500/10 rounded-full filter blur-3xl animate-pulse-slow animation-delay-2000" />
      <div className="absolute top-1/3 right-1/4 w-48 h-48 bg-pink-500/10 rounded-full filter blur-3xl animate-pulse-slow animation-delay-4000" />

      {/* Grid pattern background */}
      <div className="absolute inset-0 bg-grid-white/10 dark:bg-grid-gray-800/10 bg-[size:40px_40px]" />
          ...
          <div className="flex-1 order-2 md:order-1 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-6">
              <Link
                ...
                target="_blank"
                className="w-12 h-12 flex items-center justify-center bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 transition-all hover:shadow-lg hover:-translate-y-1"
